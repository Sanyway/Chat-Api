...
const removeConversation = async (id) => {
 ...
 /*createConversation({
     title: 'Conversacion Satiao - Juana',// Titulo del chat
     ownerId: 'c3a2dc54-454e-44d1-af84-77103ce93e6c', // Satiao
     participantId: '49465417-244d-4091-8850-e46823a7b77a' // Juana
})
